---
title: "PCA Plot Muday lab 72_F3H_PollenTube Data"
author: "Molly Davis"
date: "`r Sys.Date()`"
output:
...
combined
```
The following PCA plots are combined onto one figure for easier visualization and contain colors that are colorblind safe. 
