...
a28tib <- tibble(rownames_to_column(a28df), rownames_to_column(a34df))
...
tmp2 <- pivot_wider(tmp, names_from="experiment", values_from = Most_Likely_Path, values_fill = NA)

## Create a master table of all 6 results that we can save as an Excel file
## 
